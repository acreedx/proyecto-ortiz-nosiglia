...
import CloseSessionIcon from "../icons/close-session-icon";
import { mostrarAlertaError } from "../../lib/sweetalert/alerts";
      ...
      {session && session.user && (
        ...
        >
          ...
          >
            ...
            {dropdownOpen ? <FaArrowDown /> : <FaArrowUp />}
          </Link>
          {dropdownOpen && (
            <div
            ...
            >
              <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                <li>
                  <Link
                    href={`/`}
                    className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-orange-500 lg:text-base"
                  >
                    Editar tu perfil
                  </Link>
                </li>
