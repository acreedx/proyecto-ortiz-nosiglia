...
// Convierte campos anidados "doctor.staff.user.first_name"
...
function buildAppointmentFilter(filterModel?: FilterModel) {
...
export async function getAppointments({
  ...
  const filters = buildAppointmentFilter(filterModel);
